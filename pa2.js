...
$(function() {
    ...
    setElementAsColorPicker("#colorPicker", "#colorText", colorPalette, diffuseColor);
    setElementAsColorPicker("#specularColorPicker", "#specularColorText", colorPalette, specularColor);
    
    webGLStart();
});

function setElementAsColorPicker(picker, text, pallette, colorArray) {
    $(picker).spectrum({
        color: "#3d85c6",
        ...
        change: function(color) {
            ...
            $(text).html(color.toHexString());

            colorArray[0] = color_.r/255.0;
            colorArray[1] = color_.g/255.0;
            colorArray[2] = color_.b/255.0;
        }        
    });
}